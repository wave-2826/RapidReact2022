 ...
 */
class TaxiTwoBallAuto
    : public frc2::CommandHelper<frc2::SequentialCommandGroup, TaxiTwoBallAuto> {

public:
    
    TaxiTwoBallAuto(Punch* punch, Drive* drive, Intake* intake, Transport* transport);
    TaxiTwoBallAuto(){};
